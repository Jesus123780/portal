const esJSON = {
  ...
  'Tokyo White NextJS Typescript Admin Dashboard':
  ...
  Provider: 'Proveedor',
  QA: 'QA',
  'List of reports': 'Lista de reportes',
  Masters: 'Maestros',
  ...
  'Provider zones': 'Zonas de proveedores',
  Comission: 'Comisión',
  'Period of time': 'Periodo de tiempo',
  'Comission group': 'Grupo de comisiones',
  'Formalizers assignment': 'Asignación de formalizadores',
  'Comission Provider': 'Proveedor de comisiones',
  'Sign in': 'Iniciar sesión',
  'Fill in the fields below to sign into your account.':
    'Rellena los campos para ingresar en tu cuenta.',
  'Email address': 'Correo electrónico',
  Password: 'Contraseña',
  'The email provided should be a valid email address':
    'El correo ingresado debe ser un correo electrónico válido',
  'The user field is required': 'El usuario es un campo requerido',
  'The password field is required': 'La contraseña es un campo requerido',
